...
public:
    ...
    QLineEdit *interval;
    QLineEdit *DlibModel;
    QLabel *intervalInfo_7;
    QLineEdit *G8MKeyIndexes;
    QLabel *intervalInfo_8;
    QLabel *intervalInfo_9;
    QLineEdit *G8MModel;
    QGroupBox *groupBox;
    QLabel *portInfo_3;
    QLabel *portInfo_4;
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        Dialog->resize(434, 520);
        tabWidget = new QTabWidget(Dialog);
        tabWidget->setObjectName(QString::fromUtf8("tabWidget"));
        tabWidget->setGeometry(QRect(10, 10, 411, 461));
        General = new QWidget();
        General->setObjectName(QString::fromUtf8("General"));
        groupBox_2 = new QGroupBox(General);
        groupBox_2->setObjectName(QString::fromUtf8("groupBox_2"));
        groupBox_2->setGeometry(QRect(10, 20, 381, 291));
        intervalInfo = new QLabel(groupBox_2);
        intervalInfo->setObjectName(QString::fromUtf8("intervalInfo"));
        intervalInfo->setGeometry(QRect(27, 50, 108, 16));
        portInfo = new QLabel(groupBox_2);
        portInfo->setObjectName(QString::fromUtf8("portInfo"));
        portInfo->setGeometry(QRect(27, 24, 60, 16));
        intervalInfo_2 = new QLabel(groupBox_2);
        intervalInfo_2->setObjectName(QString::fromUtf8("intervalInfo_2"));
        intervalInfo_2->setGeometry(QRect(27, 76, 60, 16));
        BFMModel = new QLineEdit(groupBox_2);
        BFMModel->setObjectName(QString::fromUtf8("BFMModel"));
        BFMModel->setGeometry(QRect(141, 76, 133, 20));
        BFMKeyIndexes = new QLineEdit(groupBox_2);
        BFMKeyIndexes->setObjectName(QString::fromUtf8("BFMKeyIndexes"));
        BFMKeyIndexes->setGeometry(QRect(141, 128, 133, 20));
        intervalInfo_3 = new QLabel(groupBox_2);
        intervalInfo_3->setObjectName(QString::fromUtf8("intervalInfo_3"));
        intervalInfo_3->setGeometry(QRect(27, 128, 96, 16));
        G8M2BFM = new QLineEdit(groupBox_2);
        G8M2BFM->setObjectName(QString::fromUtf8("G8M2BFM"));
        G8M2BFM->setGeometry(QRect(141, 206, 133, 20));
        BFM2G8M = new QLineEdit(groupBox_2);
        BFM2G8M->setObjectName(QString::fromUtf8("BFM2G8M"));
        BFM2G8M->setGeometry(QRect(141, 180, 133, 20));
        intervalInfo_4 = new QLabel(groupBox_2);
        intervalInfo_4->setObjectName(QString::fromUtf8("intervalInfo_4"));
        intervalInfo_4->setGeometry(QRect(27, 180, 54, 16));
        intervalInfo_5 = new QLabel(groupBox_2);
        intervalInfo_5->setObjectName(QString::fromUtf8("intervalInfo_5"));
        intervalInfo_5->setGeometry(QRect(27, 206, 54, 16));
        SelectEB = new QLineEdit(groupBox_2);
        SelectEB->setObjectName(QString::fromUtf8("SelectEB"));
        SelectEB->setGeometry(QRect(141, 232, 133, 20));
        intervalInfo_6 = new QLabel(groupBox_2);
        intervalInfo_6->setObjectName(QString::fromUtf8("intervalInfo_6"));
        intervalInfo_6->setGeometry(QRect(27, 232, 60, 16));
        port = new QLineEdit(groupBox_2);
        port->setObjectName(QString::fromUtf8("port"));
        port->setGeometry(QRect(141, 24, 133, 20));
        interval = new QLineEdit(groupBox_2);
        interval->setObjectName(QString::fromUtf8("interval"));
        interval->setGeometry(QRect(141, 50, 133, 20));
        DlibModel = new QLineEdit(groupBox_2);
        DlibModel->setObjectName(QString::fromUtf8("DlibModel"));
        DlibModel->setGeometry(QRect(141, 258, 133, 20));
        intervalInfo_7 = new QLabel(groupBox_2);
        intervalInfo_7->setObjectName(QString::fromUtf8("intervalInfo_7"));
        intervalInfo_7->setGeometry(QRect(27, 258, 66, 16));
        G8MKeyIndexes = new QLineEdit(groupBox_2);
        G8MKeyIndexes->setObjectName(QString::fromUtf8("G8MKeyIndexes"));
        G8MKeyIndexes->setGeometry(QRect(141, 154, 133, 20));
        intervalInfo_8 = new QLabel(groupBox_2);
        intervalInfo_8->setObjectName(QString::fromUtf8("intervalInfo_8"));
        intervalInfo_8->setGeometry(QRect(27, 154, 96, 16));
        intervalInfo_9 = new QLabel(groupBox_2);
        intervalInfo_9->setObjectName(QString::fromUtf8("intervalInfo_9"));
        intervalInfo_9->setGeometry(QRect(27, 102, 60, 16));
        G8MModel = new QLineEdit(groupBox_2);
        G8MModel->setObjectName(QString::fromUtf8("G8MModel"));
        G8MModel->setGeometry(QRect(141, 102, 133, 20));
        groupBox = new QGroupBox(General);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        groupBox->setGeometry(QRect(10, 320, 381, 111));
        ...
        layoutWidget->setGeometry(QRect(10, 480, 381, 25));
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        SelectEB->setText(QString());
        intervalInfo_6->setText(QCoreApplication::translate("Dialog", "SELECT EB:", nullptr));
        DlibModel->setText(QString());
        intervalInfo_7->setText(QCoreApplication::translate("Dialog", "Dlib Model:", nullptr));
        G8MKeyIndexes->setText(QString());
        intervalInfo_8->setText(QCoreApplication::translate("Dialog", "G8M Key Indexes:", nullptr));
        intervalInfo_9->setText(QCoreApplication::translate("Dialog", "G8M Model:", nullptr));
        G8MModel->setText(QString());
